...
public class ModeloController {
     ...
     */
    @GetMapping("{id}")
    public ResponseEntity<Object> getModelosById(@PathVariable(value = "id") Integer id) {
        try {
     ...
     **/
    @PutMapping("/{id}")
    public ResponseEntity<String> atualizarModelos(Modelo modelo) {
